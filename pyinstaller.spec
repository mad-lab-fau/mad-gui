...
a = Analysis(['mad_gui/start_gui.py'],
             ...
             binaries=[],
             datas=[(f'{site_packages_path}/mad_gui/qt_designer/build/load_from_plugin.py', 'mad_gui/qt_designer/build/'),
		    (f'{site_packages_path}/mad_gui/qt_designer/build/plugin_selection.py', 'mad_gui/qt_designer/build/'),
		    (f'{site_packages_path}/mad_gui/qt_designer/build/channel_selector.py', 'mad_gui/qt_designer/build/'),
    		    (f'{site_packages_path}/mad_gui/qt_designer/build/load.py', 'mad_gui/qt_designer/build/'),
		    (f'{site_packages_path}/mad_gui/qt_designer/build/main.py', 'mad_gui/qt_designer/build/'),
