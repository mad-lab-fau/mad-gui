...
[![Loading data and navigating in the plot](./docs/_static/images/video_thumbnails/loading_and_navigating.png =250x)](https://www.youtube.com/watch?v=Vq45DcQAVnQ "MaD GUI - Loading data and navigating in the plot")
